...
void gui_init(uint32_t startScreenDurationMs) {
    ...
    Paint_DrawString_EN(60, 40, "USB", &Font16, WHITE, BLACK);

    Paint_DrawString_EN(5, 60, "DAP", &Font16, BLUE, BLACK);
    Paint_DrawString_EN(5, 80, "Conn", &Font16, WHITE, BLACK);
    Paint_DrawString_EN(5, 100, "Run", &Font16, WHITE, BLACK);

    Paint_DrawString_EN(100, 60,  "Serial", &Font16, BLUE, BLACK);
    Paint_DrawString_EN(100, 80,  "Tx", &Font16, WHITE, BLACK);
    Paint_DrawString_EN(100, 100, "RX", &Font16, WHITE, BLACK);
